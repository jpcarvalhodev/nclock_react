...
export const NhologramDashboard = () => {
    ...
    const [activeKey, setActiveKey] = useState<TabName>('NIDTEC - Tecnologia');
    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="dashboard-content-wrapper">
                ...
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">SOFTWARE NHOLOGRAM - Projetor Holograma</h3>
                    ...
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidtec.pt/produto/software-nhologram/" target="_blank" rel="noopener noreferrer">aqui</a></p>
