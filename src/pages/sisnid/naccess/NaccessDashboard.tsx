...
import product_naccess from "../../../assets/img/carousel/product_naccess.webp";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_naccess} alt="Naccess" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Naccess - Controlo Acessos</h3>
                    <p className="dashboard-text-inside">
                        O Naccess é um software de controlo de acessos, desenvolvido para responder às grandes necessidades da esfera de recursos humanos de uma entidade corporativa. Ele permite-lhe:
                    </p>
                    ...
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://naccess.pt/" target="_blank" rel="noopener noreferrer">aqui</a></p>
