...
import product_ncount from "../../../assets/img/carousel/product_ncount.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_ncount} alt="Ncount" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Ncount - Gestão Contador de Pessoas</h3>
                    <p className="dashboard-text-inside">
                        O Ncount é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Contagem de Pessoas. Ele permite-lhe:
                    </p>
                    <p>- Controlar o número de pessoas em tempo real;</p>
                    <p>- Efetuar uma taxa de conversão de vendas;</p>
