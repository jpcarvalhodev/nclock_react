...
import product_nevents from "../../../assets/img/carousel/product_nevents.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nevents} alt="Nevents" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nevents - Gestão de Eventos</h3>
                    <p className="dashboard-text-inside">
                        O Nevents é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Gestão de Eventos. Ele permite-lhe:
                    </p>
                    <p>- Criar um sistema monetário próprio;</p>
                    <p>- Analisar e gerir os consumos e brindes;</p>
                    <p>- Acreditar convidados consoante a categoria;</p>
                    <p>- Imprimir credenciais em tempo real;</p>
                    <p>- Gerir mesas e plantas de recinto;</p>
                    <p>- Capturar e gerir fotografias em tempo real.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-nevents/" target="_blank" rel="noopener noreferrer">aqui</a></p>
