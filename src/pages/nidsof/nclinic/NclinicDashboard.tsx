...
import product_nclinic from "../../../assets/img/carousel/product_nclinic.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nclinic} alt="Nclinic" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nclinic - Gestão de Clínicas</h3>
                    <p className="dashboard-text-inside">
                        O Nclinic é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão de Hospitais e Clínicas. Ele permite-lhe:
                    </p>
                    <p>- Agendar consultas e analisar o histórico de cada paciente;</p>
                    <p>- Emitir faturas e talões;</p>
                    <p>- Emitir SMS a lembrar da consulta;</p>
                    <p>- Criar listas de espera.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-nclinic/" target="_blank" rel="noopener noreferrer">aqui</a></p>
