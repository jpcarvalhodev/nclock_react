...
import product_nmechanic from "../../../assets/img/carousel/product_nmechanic.png";
...
export const NmechanicDashboard = () => {
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nmechanic} alt="Nmechanic" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nmechanic - Gestão de Oficinas</h3>
                    <p className="dashboard-text-inside">
                        O Nmechanic é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Gestão de Oficinas. Ele permite-lhe:
                    </p>
                    <p>- Registar a entrada e saída de viaturas;</p>
