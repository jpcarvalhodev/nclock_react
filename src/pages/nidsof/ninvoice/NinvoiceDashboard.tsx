...
import product_ninvoice from "../../../assets/img/carousel/product_ninvoice.png";
...
export const NinvoiceDashboard = () => {
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_ninvoice} alt="Ninvoice" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Ninvoice - Gestão Faturação</h3>
                    <p className="dashboard-text-inside">
                        O Ninvoice é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão de Faturação. Ele permite-lhe:
                    </p>
                    <p>- Monitorizar os backups diários;</p>
                    <p>- Gerir documentos a partir de webservice;</p>
                    <p>- Gerir filiais e consultar dados de clientes e stocks;</p>
