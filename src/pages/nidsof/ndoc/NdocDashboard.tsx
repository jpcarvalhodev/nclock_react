...
import product_ndoc from "../../../assets/img/carousel/product_ndoc.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_ndoc} alt="Ndoc" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Ndoc - Gestão Documental</h3>
                    <p className="dashboard-text-inside">
                        O Ndoc é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão Documental. Ele permite-lhe:
                    </p>
                    <p>- Controlar acessos por utilizador otimizado;</p>
