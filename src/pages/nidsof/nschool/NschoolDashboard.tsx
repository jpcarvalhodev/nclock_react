            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nschool} alt="Nschool" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nschool - Gestão Escolar</h3>
                    <p className="dashboard-text-inside">
                        O Nschool é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão de Escolas e similares. Ele permite-lhe:
                    </p>
                    <p>- Apoiar nas rotinas das comunidades educativas;</p>
                    <p>- Gerir refeitórios e prolongamentos de horário;</p>
