...
import product_nsports from "../../../assets/img/carousel/product_nsports.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nsports} alt="Nsports" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nsports - Gestão de Desporto</h3>
                    <p className="dashboard-text-inside">
                        O Nsports é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão Desportiva. Ele permite-lhe:
                    </p>
                    <p>- Definir a estrutura das equipas, treinadores, colaboradores, etc;</p>
                    <p>- Planear, de forma, detalhada as épocas desportivas;</p>
