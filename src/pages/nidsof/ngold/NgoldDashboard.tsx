...
import product_ngold from "../../../assets/img/carousel/product_ngold.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_ngold} alt="Ngold" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Ngold - Gestão Ourivesarias</h3>
                    <p className="dashboard-text-inside">
                        O Ngold é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão de Ourivesarias. Ele permite-lhe:
                    </p>
                    <p>- Identificar peças para reparação;</p>
                    <p>- Enviar SMS de alerta do estado do produto;</p>
                    <p>- Praticar tabelas próprias;</p>
                    <p>- Interligar com plataformas e-commerce.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-ngold/" target="_blank" rel="noopener noreferrer">aqui</a></p>
