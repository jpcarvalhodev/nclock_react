...
import product_nservice from "../../../assets/img/carousel/product_nservice.png";
...
export const NserviceDashboard = () => {
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nservice} alt="Nservice" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nservice</h3>
                    <p className="dashboard-text-inside">
                        O Nservice é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Gestão de Serviços. Ele permite-lhe:
                    </p>
                    <p>- Aceder à agenda e marcações;</p>
                    <p>- Gerir serviços e tarefas;</p>
                    <p>- Controlar o tempo de cada atividade;</p>
                    <p>- Organizar e delegar serviços.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-nservice/" target="_blank" rel="noopener noreferrer">aqui</a></p>
