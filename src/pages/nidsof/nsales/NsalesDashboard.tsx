...
import product_nsales from "../../../assets/img/carousel/product_nsales.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nsales} alt="Nsales" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nsales - Gestão Comercial</h3>
                    <p className="dashboard-text-inside">
                        O Nsales é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão de Vendas. Ele permite-lhe:
                    </p>
                    <p>- Tipificar documentos predifinidos para uma melhor parametrização;</p>
                    <p>- Controlar o número de vias emitidas;</p>
                    <p>- Rastrear lotes, números de série e edições;</p>
                    <p>- Identificar os preços de custo;</p>
                    <p>- Emitir documentos online;</p>
                    <p>- Disponibilizar faturas eletrónicas.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-nsales/" target="_blank" rel="noopener noreferrer">aqui</a></p>
