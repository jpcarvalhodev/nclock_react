...
import product_ntask from "../../../assets/img/carousel/product_ntask.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_ntask} alt="Ntask" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Ntask - Gestão de Tarefas</h3>
                    <p className="dashboard-text-inside">
                        O Ntask é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Gestão de Tarefas. Ele permite-lhe:
                    </p>
                    <p>- Aceder à agenda e marcações;</p>
                    <p>- Gerir tarefas e serviços;</p>
                    <p>- Controlar o tempo de cada atividade;</p>
                    <p>- Organizar e delegar tarefas.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-ntask/" target="_blank" rel="noopener noreferrer">aqui</a></p>
