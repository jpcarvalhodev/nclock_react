...
import product_noptics from "../../../assets/img/carousel/product_noptics.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_noptics} alt="Noptics" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Noptics - Gestão Ópticas</h3>
                    <p className="dashboard-text-inside">
                        O Noptics é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão de Óticas. Ele permite-lhe:
                    </p>
                    <p>- Gerir, de forma integrada, os grupos óticos;</p>
                    <p>- Atualizar o stock em tempo real;</p>
