...
import product_nticket from "../../../assets/img/carousel/product_nticket.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nticket} alt="Nticket" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nticket - Gestão de Bilhetes</h3>
                    <p className="dashboard-text-inside">
                        O Nticket é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Gestão de Bilhetes. Ele permite-lhe:
                    </p>
                    <p>- Gerir atendimento e filas de espera;</p>
                    <p>- Garantir um atendimento por ordem de chegada de clientes;</p>
                    <p>- Manter serviços rápidas, sem longas filas de espera;</p>
                    <p>- Efetuar uma manutenção simples e fácil do equipamento;</p>
                    <p>- Implementar um sistema de senhas online;</p>
                    <p>- Diminuir a taxa de desistência, a perceção do tempo de espera e a satisfação do cliente.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-nticket/" target="_blank" rel="noopener noreferrer">aqui</a></p>
