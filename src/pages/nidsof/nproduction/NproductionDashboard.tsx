...
import product_nproduction from "../../../assets/img/carousel/product_nproduction.png";
...
export const NproductionDashboard = () => {
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_nproduction} alt="Nproduction" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Nproduction - Gestão de Produção</h3>
                    <p className="dashboard-text-inside">
                        O Nproduction é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Gestão de Produção. Ele permite-lhe:
                    </p>
                    <p>- Gerir, automaticamente, os stocks disponíveis;</p>
                    <p>- Calcular custos reais e orçamentais;</p>
                    <p>- Planear a produção e controlar a produção;</p>
                    <p>- Realizar listas de material;</p>
                    <p>- Emitir documentos e etiquetas.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-nproduction/" target="_blank" rel="noopener noreferrer">aqui</a></p>
