...
import product_ncaravan from "../../../assets/img/carousel/product_ncaravan.png";
...
export const NcaravanDashboard = () => {
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_ncaravan} alt="Ncaravan" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Ncaravan - Gestão de Autocaravanas</h3>
                    <p className="dashboard-text-inside">
                        O Ncaravan é um software pensado para as diferentes necessidades de controlo das empresas, no âmbito da Gestão de Parques de Caravanas. Ele permite-lhe:                    </p>
                    <p>- Gerir autonomamente o parqueamento de caravanas;</p>
                    <p>- Integrar entidades gestoras das transações, para pagamentos automáticos;</p>
                    <p>- Integrar com dispositivos de fornecimento de energia;</p>
