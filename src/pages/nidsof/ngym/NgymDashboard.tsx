...
import product_ngym from "../../../assets/img/carousel/product_ngym.png";
            ...
            <div className="dashboard-content-wrapper">
                <div className="dashboard-carousel-container">
                    <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showArrows={false} emulateTouch={true}>
                        <div>
                            <img className="img-carousel" src={product_ngym} alt="Ngym" />
                        </div>
                    </Carousel>
                </div>
                <div className="dashboard-carousel-container">
                    <h3 className="dashboard-title-text-inside">Software Ngym - Gestão de Ginásios</h3>
                    <p className="dashboard-text-inside">
                        O Ngym é um software pensado para as diferentes necessidades de gestão das empresas, no âmbito da Gestão de Ginásios. Ele permite-lhe:
                    </p>
                    <p>- Gerir acessos às instalações;</p>
                    <p>- Controlar cartões e planos de pagamento;</p>
                    <p>- Administrar marcações e reservas;</p>
                    <p>- Acionar envio de avisos e informações;</p>
                    <p>- Gerir documentos e faturação.</p>
                    <p style={{ marginTop: 30 }}>Para mais detalhes do software, visite o site <a href="https://nidsof.pt/produto/software-ngym/" target="_blank" rel="noopener noreferrer">aqui</a></p>
