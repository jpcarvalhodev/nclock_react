...
export const Temporaries = () => {
  ...
  const deleteSelectedEmployees = async (employeeIds: string[]) => {
   ...
   // Atualiza a tabela de provisórios ao montar o componente
   useEffect(() => {
    setFilteredEmployees(disabledEmployees.filter((emp) => emp.type === "Provisório"));
  ...
  return (
    <div className="main-container">
      ...
      <AddEmployeeToPersonFilterModal
        title="Adicionar Pessoa aos Provisórios"
