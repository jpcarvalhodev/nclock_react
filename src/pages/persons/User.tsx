...
export const User = () => {
  ...
  const fetchPaginationPersons = async (pageNo: string, perPage: string) => {
    ...
    try {
      ...
      const onlyUtente = data.data.filter((emp: Employee) => emp.type === "Utente");
      setFilteredEmployees(onlyUtente);
  ...
  useEffect(() => {
    let filtered = disabledEmployees.filter((emp) => emp.type === "Utente");
  ...
  return (
    <div className="main-container">
      ...
      <AddEmployeeToPersonFilterModal
        title="Adicionar Pessoa aos Utentes"
