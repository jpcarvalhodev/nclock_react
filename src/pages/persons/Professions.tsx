...
export const Professions = () => {
    ...
    const actionColumn: TableColumn<Profession> = {
        ...
        cell: (row: Profession) => (
            <div style={{ display: 'flex' }}>
                ...
                >
                    <CustomOutlineButton className="action-button" icon='bi bi-trash-fill' onClick={() => handleOpenDeleteModal(row.professionID)} />
                </OverlayTrigger>
            </div>
        ),
    ...
    const getSelectedFields = () => {
        return professionFields.filter(field => selectedColumns.includes(field.key));
    };
