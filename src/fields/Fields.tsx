...
export const timePeriodFields = [
    ...
    { key: 'mondayStart2', label: 'Monday Start 2', type: 'string' },
    { key: 'mondayEnd2', label: 'Monday End 2', type: 'string' },
    { key: 'mondayStart3', label: 'Monday Start 3', type: 'string' },
    { key: 'mondayEnd3', label: 'Monday End 3', type: 'string' },
    { key: 'tuesdayStart1', label: 'Terça Início', type: 'string' },
    { key: 'tuesdayEnd1', label: 'Terça Fim', type: 'string' },
    { key: 'tuesdayStart2', label: 'Tuesday Start 2', type: 'string' },
    { key: 'tuesdayEnd2', label: 'Tuesday End 2', type: 'string' },
    { key: 'tuesdayStart3', label: 'Tuesday Start 3', type: 'string' },
    { key: 'tuesdayEnd3', label: 'Tuesday End 3', type: 'string' },
    { key: 'wednesdayStart1', label: 'Quarta Início', type: 'string' },
    { key: 'wednesdayEnd1', label: 'Quarta Fim', type: 'string' },
    { key: 'wednesdayStart2', label: 'Wednesday Start 2', type: 'string' },
    { key: 'wednesdayEnd2', label: 'Wednesday End 2', type: 'string' },
    { key: 'wednesdayStart3', label: 'Wednesday Start 3', type: 'string' },
    { key: 'wednesdayEnd3', label: 'Wednesday End 3', type: 'string' },
    { key: 'thursdayStart1', label: 'Quinta Início', type: 'string' },
    { key: 'thursdayEnd1', label: 'Quinta Fim', type: 'string' },
    { key: 'thursdayStart2', label: 'Thursday Start 2', type: 'string' },
    { key: 'thursdayEnd2', label: 'Thursday End 2', type: 'string' },
    { key: 'thursdayStart3', label: 'Thursday Start 3', type: 'string' },
    { key: 'thursdayEnd3', label: 'Thursday End 3', type: 'string' },
    { key: 'fridayStart1', label: 'Sexta Início', type: 'string' },
    { key: 'fridayEnd1', label: 'Sexta Fim', type: 'string' },
    { key: 'fridayStart2', label: 'Friday Start 2', type: 'string' },
    { key: 'fridayEnd2', label: 'Friday End 2', type: 'string' },
    { key: 'fridayStart3', label: 'Friday Start 3', type: 'string' },
    { key: 'fridayEnd3', label: 'Friday End 3', type: 'string' },
    { key: 'saturdayStart1', label: 'Sábado Início', type: 'string' },
    { key: 'saturdayEnd1', label: 'Sábado Fim', type: 'string' },
    { key: 'saturdayStart2', label: 'Saturday Start 2', type: 'string' },
    { key: 'saturdayEnd2', label: 'Saturday End 2', type: 'string' },
    { key: 'saturdayStart3', label: 'Saturday Start 3', type: 'string' },
    { key: 'saturdayEnd3', label: 'Saturday End 3', type: 'string' },
    { key: 'sundayStart1', label: 'Domingo Início', type: 'string' },
    { key: 'sundayEnd1', label: 'Domingo Fim', type: 'string' },
    { key: 'sundayStart2', label: 'Sunday Start 2', type: 'string' },
    { key: 'sundayEnd2', label: 'Sunday End 2', type: 'string' },
    { key: 'sundayStart3', label: 'Sunday Start 3', type: 'string' },
    { key: 'sundayEnd3', label: 'Sunday End 3', type: 'string' },
    { key: 'holidayType1Start1', label: 'Feriado Início', type: 'string' },
    { key: 'holidayType1End1', label: 'Feriado Fim', type: 'string' },
    { key: 'holidayType1Start2', label: 'Holiday Type 1 Start 2', type: 'string' },
    { key: 'holidayType1End2', label: 'Holiday Type 1 End 2', type: 'string' },
    { key: 'holidayType1Start3', label: 'Holiday Type 1 Start 3', type: 'string' },
    { key: 'holidayType1End3', label: 'Holiday Type 1 End 3', type: 'string' },
    { key: 'holidayType2Start1', label: 'Holiday Type 2 Start 1', type: 'string' },
    { key: 'holidayType2End1', label: 'Holiday Type 2 End 1', type: 'string' },
    { key: 'holidayType2Start2', label: 'Holiday Type 2 Start 2', type: 'string' },
    { key: 'holidayType2End2', label: 'Holiday Type 2 End 2', type: 'string' },
    { key: 'holidayType2Start3', label: 'Holiday Type 2 Start 3', type: 'string' },
    { key: 'holidayType2End3', label: 'Holiday Type 2 End 3', type: 'string' },
    { key: 'holidayType3Start1', label: 'Holiday Type 3 Start 1', type: 'string' },
    { key: 'holidayType3End1', label: 'Holiday Type 3 End 1', type: 'string' },
    { key: 'holidayType3Start2', label: 'Holiday Type 3 Start 2', type: 'string' },
    { key: 'holidayType3End2', label: 'Holiday Type 3 End 2', type: 'string' },
    { key: 'holidayType3Start3', label: 'Holiday Type 3 Start 3', type: 'string' },
    { key: 'holidayType3End3', label: 'Holiday Type 3 End 3', type: 'string' }
];
...
export const doorsFields = [
    ...
    { key: 'doorNo', label: 'Nº Porta', type: 'number', readonly: true, required: true },
...
const createLicenseFields = (products: string[]) => {
    ...
    products.forEach(product => {
        fields.push(
            ...
            { key: `${product}.createDate`, label: `${product} Data de Criação`, type: 'date' },
