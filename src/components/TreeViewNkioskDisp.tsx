...
interface TreeViewDataNkioskDispProps {
...
// Define o componente
export function TreeViewDataNkioskDisp({ onSelectDevices }: TreeViewDataNkioskDispProps) {
    ...
    useEffect(() => {
        const buildDeviceTree = deviceData.map(device => ({
            id: device.serialNumber || `Sem SN ${device.deviceName}`,
