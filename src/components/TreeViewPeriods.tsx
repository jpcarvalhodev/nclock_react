...
interface TreeViewDataPeriodsProps {
...
// Define o componente
export function TreeViewDataPeriods({ onSelectDevices }: TreeViewDataPeriodsProps) {
    const { period, fetchTimePeriods } = useTerminals();
    ...
    return (
        <Box className="TreeViewContainer">
            ...
            <div style={{ display: 'flex' }}>
                ...
                >
                    <CustomOutlineButton className='treeview-button' icon="bi-arrow-clockwise" onClick={() => fetchTimePeriods()} iconSize='1.1em'></CustomOutlineButton>
                </OverlayTrigger>
            </div>
