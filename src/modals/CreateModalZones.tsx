...
// Define o componente
export const CreateModalZones = <T extends Record<string, any>>({
  title,
  open,
  onClose,
  onSave,
      ...
      <Modal.Body className="modal-body-scrollable">
        <Row>
          ...
          <Col md={3}>
            <Form.Group controlId="formAcronym">
              ...
              {errors.acronym && (
                <Form.Text className="text-danger">{errors.acronym}</Form.Text>
              )}
            </Form.Group>
          </Col>
          <Col md={3}>
        ...
        <Tab.Container defaultActiveKey="dadosGerais">
          <Nav variant="tabs" className="nav-modal">
            ...
            <Nav.Item>
              <Nav.Link eventKey="dadosComplementares">
