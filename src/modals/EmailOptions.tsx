...
export const EmailOptionsModal = <T extends Record<string, any>>({
  title,
  open,
  onClose,
  onSave,
  ...
  const validateForm = () => {
    ...
    if (
      emailFormData.usernameEmail &&
      !validateEmail(emailFormData.usernameEmail as string)
    ) {
      isValid = false;
      newErrors["usernameEmail"] = {
        hasError: true,
  ...
  const handleAddOrUpdate = () => {
    if (
      entity.usernameEmail !== "" &&
      entity.passwordEmail !== "" &&
      entity.hostSMTP !== "" &&
      entity.portSMTP !== ""
    ) {
      handleUpdateClick();
                  ...
                  <Row style={{ flex: 1.5 }}>
                    ...
                    <Col md={6}>
                      <Form.Group controlId="formPasswordEmail">
                        ...
                        {errors["passwordEmail"] &&
                          errors["passwordEmail"].hasError && (
                            <Form.Text className="text-danger">
                              {errors["passwordEmail"].message}
                            </Form.Text>
                          )}
                      </Form.Group>
                    </Col>
                    <Col md={6}>
                      <Form.Group controlId="formHostSMTP">
                        ...
                        {errors["hostSMTP"] && errors["hostSMTP"].hasError && (
                          <Form.Text className="text-danger">
                            {errors["hostSMTP"].message}
                          </Form.Text>
                        )}
                      </Form.Group>
                    </Col>
                    <Col md={6}>
                      <Form.Group controlId="formPortSMTP">
                        ...
                        {errors["portSMTP"] && errors["portSMTP"].hasError && (
                          <Form.Text className="text-danger">
                            {errors["portSMTP"].message}
                          </Form.Text>
                        )}
                      </Form.Group>
                    </Col>
