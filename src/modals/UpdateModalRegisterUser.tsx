...
export const UpdateModalRegisterUsers = <T extends Entity>({
  title,
  open,
  onClose,
  onUpdate,
  ...
  useEffect(() => {
    if (open && entity) {
      setFormData({ ...entity });
      const imageURL = entity.profileImage
        ? `${apiService.baseURL?.slice(0, -1)}${entity.profileImage}`
        : modalAvatar;
  ...
  const validateForm = () => {
    ...
    if (
      ...
      !validateEmail(formData.emailAddress as string)
    ) {
      isValid = false;
    ...
    if (formData.password && !validatePassword(formData.password as string)) {
      ...
      newErrors["password"] = {
        hasError: true,
        message:
          "A password deve ter pelo menos 6 caracteres, uma letra maiúscula, uma minúscula e um caractere especial.",
      };
    }
  ...
  const handleChange = (
    ...
    if (type === "checkbox") {
      ...
      parsedValue =
        name === "userName" || name === "password" || name === "confirmPassword"
          ? value.replace(/\s+/g, "")
          : value;
    }
          ...
          <Row>
            ...
            <Col md={3}>
              ...
              <Form.Group controlId="formEmailAddress">
                ...
                {errors["emailAddress"] && errors["emailAddress"].hasError && (
                  <Form.Text className="text-danger">
              ...
              >
                <Form.Label>
                  Alterar Password <span style={{ color: "red" }}>*</span>
                </Form.Label>
                ...
                <Form.Text
                  ...
                  style={{ minHeight: "20px", marginTop: "5px" }}
                >
                  {showValidationErrors &&
                    errors["password"] &&
                    errors["password"].hasError &&
            ...
            <Col md={3}>
              <Form.Group controlId="formUserName">
                ...
                {errors["userName"] && errors["userName"].hasError && (
                  <Form.Text className="text-danger">
              ...
              <Form.Group controlId="formRoles">
                ...
                {errors["roles"] && errors["roles"].hasError && (
                  <Form.Text className="text-danger">
