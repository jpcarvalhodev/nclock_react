            ...
            <Tab.Content>
              ...
              <Tab.Pane eventKey="license">
                <Form style={{ marginTop: 10, marginBottom: 10 }}>
                  ...
                  <p>
                    • O software é protegido por leis de direitos de autor e
                    tratados internacionais.
                  </p>
                  <p>
                    • Qualquer reprodução ou distribuição não autorizada pode
                    levar a sanções civis e criminais.
                  </p>
                  <p style={{ marginTop: 10 }}>
                    <strong>Isenção de Garantias:</strong>
                  </p>
                  <p>
                    • O produto é fornecido "como está" ("as is"), sem garantias
                    explícitas ou implícitas.
                  </p>
                  <p>
                    • O usuário assume total responsabilidade pelos resultados e
                  ...
                  <p>
                    • O desenvolvimento do software, NIDGROUP / SISNID, não pode
                    ser responsabilizada por danos acidentais, especiais,
                    consequenciais ou indiretos (ex.: perda de lucros ou dados),
                    mesmo que tenha sido alertada sobre a possibilidade desses
                    danos.
                  </p>
                  <p>
                    • Também não se responsabiliza por demandas feitas por
                    terceiros relacionadas ao uso do software.
                  </p>
                  <p style={{ marginTop: 10 }}>
                    <strong>Proibição de Engenharia Reversa:</strong>
                  </p>
                  <p>
                    • O usuário não pode traduzir, realizar engenharia reversa,
