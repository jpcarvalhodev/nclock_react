                    ...
                    <Row>
                        <Col md={3}>
                            <Form.Group controlId="formEventTime">
                                <Form.Label>Data do Evento<span style={{ color: 'red' }}> *</span></Form.Label>
                                <OverlayTrigger
                                    placement="right"
                        ...
                        <Col md={3}>
                            <Form.Group controlId="formPin">
                                ...
                                {errors['pin'] && <div style={{ color: 'red', fontSize: 'small' }}>{errors['pin']}</div>}
                            </Form.Group>
                        </Col>
                        <Col md={3}>
                            <Form.Group controlId="formDeviceSN">
                                ...
                                <OverlayTrigger
                                    placement="right"
                                    overlay={<Tooltip id="tooltip-deviceSN">Campo obrigatório</Tooltip>}
                                >
                                    <Form.Control
                                        as="select"
                                        className={`custom-input-height custom-select-font-size ${showValidationErrors ? 'error-border' : ''}`}
                                ...
                                {errors['deviceSN'] && <div style={{ color: 'red', fontSize: 'small' }}>{errors['deviceSN']}</div>}
                            </Form.Group>
                        </Col>
                    </Row>
                </div>
